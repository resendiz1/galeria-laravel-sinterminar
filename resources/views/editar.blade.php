    ...
    <div class="container">
        ...
        <div class="row justify-content-center p-3">
            ...
            <div class="col-8 shadow p-3">
                <form action="{{route('galeria.update', $id)}}" enctype="multipart/form-data" method="POST">
                    @csrf @method('PATCH')
                    <div class="form-group">
                      <label class="form-label mb-2" for="nombre">Nombre</label>
                      <input type="text" class="form-control mb-3" value="{{ $id->name, old('nombre')}}" name="nombre" data-mdb-showcounter="true" maxlength="15" name="" id="nombre"> 
                    ...
                    <div class="form-outline my-3">
                        <input
                          ...
                          maxlength="20"
                          name="descripcion"
                          value="{{ $id->description, old('descripcion')}}"
                        />
                    ...
                    <div class="form-group text-center mb-4">
                        <img src="{{Storage::url($id->multimedia)}}" class="img-fluid border border-dark" alt="">
                    </div>
                    <div class="form-group">
